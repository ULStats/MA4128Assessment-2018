...
The following document will be an introduction to the use of Leaflet. Leaflet is a rather useful tool in the world of Geographical Information System (GIS) as a visualisation tool due to its ability to compose interactive maps. Such interactions includepanning and zooming. Large news organisations such as The New York Times and The Washington Post have used leaflet to illustrate various topics such as general election results as [shown if you click here](http://www.nytimes.com/projects/elections/2013/nyc-primary/mayor/map.html).

To demonstrate leaflets ability, a map of the 25 rainfall collecting stations in the Republic of ireland will be shown along with a pop up for each station showing its median monthly rainfall for January. 
...
setwd("~/Documents/PhD/modules/Year_1_semester_2/")
getwd()
list.files()
...
load("~/Documents/PhD/modules/Year_1_semester_2/rainfall.RData")
load("~/Documents/PhD/modules/Year_1_semester_2/maps.RData")
```
